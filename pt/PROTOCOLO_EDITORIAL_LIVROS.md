...
- Antes de gerar, reinterpretar ou compor uma capa, fazer auditoria do acervo visual: `Capas/`, a pasta especifica do livro, diretorios de `imagens/capa`, `imagens/personagens`, cenas, banners e arquivos de design editavel. Classificar cada fonte como canonica/aprovada, candidata, arquivo historico ou origem incerta.
- Em ficcao, personagens nomeados, cenarios e objetos ja estabelecidos sao referencias canonicas ate revisao expressa do autor. Nao gerar uma nova aparencia generica para eles sem examinar as referencias existentes; usar arte nova somente para preencher uma lacuna, criar derivacao coerente ou atender uma direcao de arte aprovada.
- Se ja houver capa completa forte e coerente, ela deve ser ponto de partida para adaptacao ao gabarito, e nao pretexto para reimaginar o livro. Registrar por que uma nova arte e necessaria e quais referencias foram usadas.
- A contracapa deve continuar a linguagem visual da frente: prolongar a mesma cena, panorama, ambiente, textura ou motivo narrativo, preservando imagem significativa sob a area de leitura. Um painel tonal para sinopse e aceitavel apenas se nao transformar a contracapa em campo preto opaco, vazio ou desconectado.
- E proibido simplesmente repetir ou espelhar a mesma arte frontal vertical na contracapa. Continuidade exige uma destas fontes: (a) uma unica arte panoramica concebida para o exterior inteiro, da qual se recortam contracapa e capa em posicoes diferentes; ou (b) duas artes distintas, cada uma com funcao propria, mas coerentes em cenario, personagens, objetos, epoca, luz, paleta e direcao de arte.
- Revisar frente, lombada e contracapa como uma unica composicao aberta. Aprovar separadamente continuidade de cena, contraste da sinopse, coerencia de personagens, reserva de codigo de barras e ausencia de repeticao visual entre obras.
...
- Antes de aprovar a contracapa, verificar que o tratamento de contraste nao apagou a arte nem rompeu a continuidade visual com a frente. Para ficcao, conferir tambem personagens, figurinos, epoca e cenarios contra o acervo canonico auditado.
- Registrar qual dos dois metodos foi usado (panorama externo ou duas cenas coerentes), os arquivos-fontes de cada painel e a revisao humana que comprovou que nao houve repeticao literal da arte frontal.
